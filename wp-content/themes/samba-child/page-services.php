...
-->
                ...
                <div class="prk_inner_block vc_row-fluid centered columns forent">
                    <div class="row partintro">
                        <div class="vc_col-sm-6 wpb_column vc_column_container img_hold">
                            <div class="wpb_wrapper">
                                <div class="clearfix"></div>
                                <div class="work_cont">
                                    <img src="http://loremflickr.com/1000/477/building">
                                </div>
                            </div>
                        </div>
                        <div class="vc_col-sm-6 wpb_column vc_column_container introtext">
                            <div class="wpb_wrapper">
                                <div class="clearfix"></div>
                                <div class="work_cont">
                            ...
                            <div class="wpb_wrapper">
                                ...
                                <div class="work_cont">
                                    <div class="top-tab">
                                        <div class="top_inner">
                                            <div class="set">
                                                <small class="clr_lt">Building</small>
                                                <big>D</big>
                                            </div>
                                            <div class="set">
                                                <small class="clr_lt">Floor</small>
                                                <big>10</big>
                                            </div>
                                            <div class="set">
