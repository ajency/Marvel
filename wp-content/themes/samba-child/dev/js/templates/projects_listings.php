                    ...
                    if(property_status=='Ongoing'){
                        ...
                        <% }
                            ...
                            <% if(!_.isUndefined(property_office_spaces)) { %>
                                    <% if(!_.isUndefined(property_office_spaces['min-area']) && (property_office_spaces['min-area']!='' && property_office_spaces['max-area']!='') ) { %><h6 class="ofcspace">Office Spaces: <%=property_office_spaces['min-area']%> - <%=property_office_spaces['max-area']%> Sq. Ft.</h6> <% } %>
                            <% } %>
                            <% if(!_.isUndefined(property_retail_spaces)) { %>
                                    <% if(!_.isUndefined(property_retail_spaces['min-area']) && (property_retail_spaces['min-area']!='' && property_retail_spaces['max-area']) ) { %><h6 class="retspace">Retail Spaces: <%=property_retail_spaces['min-area']%> - <%=property_retail_spaces['max-area']%> Sq. Ft.</h6> <% } %>
                            <% } %>
                        <% }
                    %>
