...
<script type="text/javascript" src = "<?php echo get_template_directory_uri(); ?>/dev/js/views/projectsCompareView.js"></script>

<script type="text/javascript" src = "<?php echo get_template_directory_uri(); ?>/dev/js/routers/PropertyListRouter.js"></script>
<?php 
require_once(ABSPATH.'/wp-content/themes/samba/dev/js/templates/projects_compare.php');
require_once(ABSPATH.'/wp-content/themes/samba/dev/js/templates/projectListingsMain.php');
require_once(ABSPATH.'/wp-content/themes/samba/dev/js/templates/projectlistSearch_option.php');
require_once(ABSPATH.'/wp-content/themes/samba/dev/js/templates/projects_compare.php');
require_once(ABSPATH.'/wp-content/themes/samba/dev/js/templates/projects_listings.php');
