<script type="text/javascript" src = "<?php echo get_template_directory_uri(); ?>/dev/js/lib/underscore.min.js"></script>
<script type="text/javascript" src = "<?php echo get_template_directory_uri(); ?>/dev/js/lib/backbone.js"></script>
